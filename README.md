...
1. Deploys up to 6 TKGm clusters (View, Build, Dev, QA, Prod, Iterate)
...
7. Installs the RabbitMQ Operator to ease starting with service bindings
8. Applies overlays to give better experience with TAP including:
